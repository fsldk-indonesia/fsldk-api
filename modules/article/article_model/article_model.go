...
type Article struct {
	...
	ArticleIntro  string     `gorm:"column:articleIntro" json:"articleIntro"`
	ArticleImage  *string    `gorm:"column:articleImage" json:"articleImage"`
	ArticleWriter *string    `gorm:"column:articleWriter" json:"articleWriter"`
	ArticleEditor *string    `gorm:"column:articleEditor" json:"articleEditor"`
	ArticlePdf    *string    `gorm:"column:articlePdf" json:"articlePdf"`
