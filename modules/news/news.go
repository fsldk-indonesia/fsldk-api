// Package news mengelola berita (publik & CMS) beserta kategorinya.
package news
...
type News struct {
	...
	NewsExcerpt   sql.NullString `db:"newsExcerpt" json:"newsExcerpt"`
	NewsContent   string         `db:"newsContent" json:"newsContent"`
	NewsImage     sql.NullString `db:"newsImage" json:"newsImage"`
