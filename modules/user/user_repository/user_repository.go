// Package user_repository adalah lapisan akses data modul user.
...
type Repository interface {
	...
	List(ctx context.Context, search string, roleID int64, limit, offset int, orderBy string) ([]user_model.User, int, error)
