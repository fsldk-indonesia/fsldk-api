...
| `qrcode_approved` | Permintaan disetujui → ke pemohon | `qrcoderequest_service_impl.go` `enqueueApprovedNotifications()` | 1 nama pemohon, 2 **tautan unduh gambar QR** (`{APP_URL}/api/v1/public/qrcodes/{id}/image?size=1024`) | — | `tmpl_C6JMZHHA5MRBWMVZ3CMX0AWNX9` | **pending** (submitted 2026-09-07) |
