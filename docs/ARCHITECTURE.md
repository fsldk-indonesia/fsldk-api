...
Setiap modul fitur (`auth`, `user`, `role`, `permission`, `news`, `article`, `event`, `comment`, `shortlink`, `setting`, `jobqueue`, `dashboard`) memiliki struktur subfolder yang identik. Contoh modul `news`:
